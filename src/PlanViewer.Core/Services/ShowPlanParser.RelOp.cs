...
public static partial class ShowPlanParser
{
    private static PlanNode ParseRelOp(XElement relOpEl, int depth = 0)
    {
        ...
        if (physicalOpEl != null)
            ParseOperatorProperties(node, relOpEl, physicalOpEl);
        ...
        ParseRuntimeInformation(node, relOpEl);
    ...
    private static void ParseOperatorProperties(PlanNode node, XElement relOpEl, XElement physicalOpEl)
    {
    ...
    private static void ParseRuntimeInformation(PlanNode node, XElement relOpEl)
    {
